...
class BaseStepperState extends State<BaseStepper> {
      ...
      (index) {
        return widget.direction == Axis.horizontal
            ? Row(
                children: <Widget>[
                  // index == 0
                  //     ? _customizedDottedLine(index, Axis.horizontal, true)
                  //     : Container(),
                  _customizedIndicator(index),
                  _customizedDottedLine(index, Axis.horizontal, false),
                ],
              )
            : Column(
                children: <Widget>[
  ...
  Widget _customizedDottedLine(int index, Axis axis, bool first) {
    return index != 3
        ? DottedLine(
            past: index < _selectedIndex,
