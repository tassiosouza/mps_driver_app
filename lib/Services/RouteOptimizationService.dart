...
class RouteOptimizationApi {
  static String baseUrl = 'https://graphhopper.com/api/1/vrp?key=110bcab4-47b7-4242-a713-bb7970de2e02';
  ...
  Future<List<Client>> getOrderedClients(List<Client> clients) async {
    ...
    for (int i =1; i < clients.length -1; i ++) {
      Client findClient(String name) => clients.firstWhere((client) => client.name == name);
