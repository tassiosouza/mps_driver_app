...
class Route extends Model {
  ...
  const Route._internal(
      ...
      : _cost = cost,
        ...
        _routeDriverId = routeDriverId;

  factory Route(
      {String? id,
      double? cost,
      TemporalTimestamp? startTime,
      TemporalTimestamp? endTime,
      RouteStatus? status,
  ...
  String toString() {
    ...
    buffer.write("startTime=" +
        (_startTime != null ? _startTime!.toString() : "null") +
        ", ");
    buffer.write(
        "endTime=" + (_endTime != null ? _endTime!.toString() : "null") + ", ");
    buffer.write(
  ...
  Route.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _startTime = json['startTime'] != null
            ? TemporalTimestamp.fromSeconds(json['startTime'])
            : null,
        _endTime = json['endTime'] != null
            ? TemporalTimestamp.fromSeconds(json['endTime'])
            : null,
        _status =
            enumFromString<RouteStatus>(json['status'], RouteStatus.values),
        _name = json['name'],
        _orders = json['orders'] is List
            ? (json['orders'] as List)
                .where((e) => e?['serializedData'] != null)
                .map((e) => MpOrder.fromJson(
                    new Map<String, dynamic>.from(e['serializedData'])))
                .toList()
            : null,
        _driver = json['driver']?['serializedData'] != null
            ? Driver.fromJson(
                new Map<String, dynamic>.from(json['driver']['serializedData']))
            : null,
  ...
  Map<String, dynamic> toJson() => {
        'id': id,
        'cost': _cost,
        'startTime': _startTime?.toSeconds(),
        'endTime': _endTime?.toSeconds(),
        'status': enumToString(_status),
        'name': _name,
        'orders': _orders?.map((MpOrder? e) => e?.toJson()).toList(),
        'driver': _driver?.toJson(),
        'createdAt': _createdAt?.format(),
        'updatedAt': _updatedAt?.format(),
        'routeDriverId': _routeDriverId
      };
  ...
  static final QueryField ROUTEDRIVERID =
      QueryField(fieldName: "routeDriverId");
  static var schema =
