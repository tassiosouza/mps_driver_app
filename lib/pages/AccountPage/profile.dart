      ...
      Container(
          ...
          decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/images/background_profile_img.png'),
                  fit: BoxFit.cover)),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.person,
                      size: 90, color: App_Colors.grey_light.value),
                ),
                SizedBox(height: 15),
                Text(
                ...
                Text("Driver",
                    style: TextStyle(
                        fontSize: 12, color: App_Colors.grey_light.value))
              ],
            ),
          ])),
      SizedBox(height: 18),
      ...
      GestureDetector(
        child: Container(
            ...
            child: Row(children: [
              Text("Logout",
                  style: TextStyle(
                      color: App_Colors.alert_color.value, fontSize: 14)),
            ])),
        onTap: () {},
      ),
    ]));
